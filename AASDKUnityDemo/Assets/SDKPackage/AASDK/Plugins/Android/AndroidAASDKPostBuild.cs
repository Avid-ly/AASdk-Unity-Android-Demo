...
#if (UNITY_2018_1_OR_NEWER)
public class AndroidAASDKPostProcessBuild : IPreprocessBuildWithReport
{
...
public class AndroidPostProcessBuild : IPreprocessBuild
{
    ...
    private string TAG = "AASDK_Plugin==>";
    string verionFilePath = "";
    private string fileName = "aasdk_version.xml";
    ...
    private string CreateVersionXml()
    {
        ...
        {
            Debug.Log(TAG + "delete old aasdk version xml");
    ...
    private void WriteVersionToXml(string xmlFilePath)
    {
        ...
        // version
        string iOS_SDK_Version = AASDK.AASDKApi.iOS_SDK_Version;
        string Android_SDK_Version = AASDK.AASDKApi.Android_SDK_Version;
        string Unity_Package_Version = AASDK.AASDKApi.Unity_Package_Version;
        ...
        //初始化第一层的第一个子节点
        XmlElement firstLevelElement1 = myXmlDoc.CreateElement("aasdk_version");
