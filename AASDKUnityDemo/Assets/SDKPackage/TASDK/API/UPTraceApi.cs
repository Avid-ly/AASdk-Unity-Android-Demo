...
namespace UPTrace
{
    ...
    {
        public readonly static string iOS_SDK_Version = "4.1.0.9";
        public readonly static string Android_SDK_Version = "4.1.1.3";
        public readonly static string Unity_Package_Version = "4.1.1.6";
		 ...
		 */
        public static void initTraceSDKWithCallback(string productId, string channelId, Action<string> success,
            Action<string> fail)
        {
            if (isInited)
            {
		 ...
		 */
        public static void traceThirdpartyZFLogReportForIos(string playerId, string thirdparty,
            string receiptDataString)
        {
            ...
            {
                Debug.Log(
                    "Fail to call traceThirdpartyZFLogReportForIos(), please initialize the analysis SDK first!!!");
            }
        }
		 ...
		 */
        public static void traceThirdpartyZFLogReportWithServerForIos(string playerId, string gameAccountServer,
            string thirdparty, string receiptDataString)
        {
            ...
            {
                Debug.Log(
                    "Fail to call traceThirdpartyZFLogReportWithServerForIos(), please initialize the analysis SDK first!!!");
            }
        }
        ...
        public static void traceZFLogReportWithPlayerIdForIos(string playerId, string receiptDataString, bool isbase64)
        {
            ...
            {
                Debug.Log(
                    "Fail to call traceZFLogReportWithPlayerIdForIos(), please initialize the analysis SDK first!!!");
            }
        }
		 ...
		 */
        public static void traceZFLogReportWithServerForIos(string playerId, string gameAccountServer,
            string receiptDataString, bool isbase64)
        {
            if (isInited)
            {
#if UNITY_IOS && !UNITY_EDITOR
            ...
            {
                Debug.Log(
                    "Fail to call traceZFLogReportWithServerForIos(), please initialize the analysis SDK first!!!");
            }
        }

        public static void traceZFLogReportWithServerForIos(string playerId, string gameAccountServer,
            string receiptDataString, bool isbase64, Dictionary<string, string> dic)
        {
            if (isInited)
            {
#if UNITY_IOS && !UNITY_EDITOR
		 ...
		 */
        public static void traceZFLogReportForAndroid(string gameAccountId, string iabPurchaseOriginalJson,
		 ...
		 */
        public static void traceZFLogReportWithServerForAndroid(string gameAccountId, string gameAccountServer,
            ...
            string iabPurchaseSignature)
        {
            ...
            {
                Debug.Log(
                    "Fail to call traceZFLogReportWithServerForAndroid(), please initialize the analysis SDK first!!!");
            }
        }
		 ...
		 * https://coding.net/u/holaverse/p/HolaAnalysisSDK/git/blob/master/android/doc/integration.md?public=true
		 */
        public static void twitterLogin(string playerId, string twitterId, string twitterUserName,
            string twitterAuthToken)
        {
            if (null == polyCall)
            {
                instanceOfCall();
		 ...
		 */
        public static void logCommonLogin(string loginType, string playerId, string loginToken,
        ...
        public static void logAASLogin(string loginType, string playerId, string loginToken, string ggid,
            Dictionary<string, string> extension)
        {
            string extensionjson = "";
            if (null == polyCall)
        ...
        */
        ...
        /*
        * 获取 AB Test数据 (playerId)
        */
        public static void getABTestDataWithPlayerId(Action<string> success, Action<string> fail, string playerId)
        {
            if (polyCall != null)
            {
                if (playerId == null || "".Equals(playerId))
                {
                    fail("player id can not be empty");
                    return;
                }

                polyCall.getABTestDataWithPlayerId(success, fail, playerId);
            }
        }
